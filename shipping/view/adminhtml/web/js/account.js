        ...
        $(document).ready(function() {
            ...
            $('#accountWith90Days').click(function() {
                if ($(this).is(':checked')) {
                    ...
                    if (!$( ".accountWithUsrPwd_show" ).hasClass( "hidden" )) {
                        $( ".accountWithUsrPwd_show" ).addClass( "hidden" );
                    }

                    $('.accountWithOut90Days_show input').removeAttr('data-validate');
                    $('.accountWithUsrPwd_show input').removeAttr('data-validate');
            ...
            var optradiovalue = $("#optradiovalue").val();
                if (optradiovalue == 1) {
                    ...
                    if ($( ".accountWithUsrPwd_show" ).hasClass( "hidden" )) {
                        $( ".accountWithUsrPwd_show" ).removeClass( "hidden" );
                    }
                }
            ...
            $('#accountWithUsrPwd').click(function() {
                if ($(this).is(':checked')) {
                    if ($( ".accountWithUsrPwd_show" ).hasClass( "hidden" )) {
                        $( ".accountWithUsrPwd_show" ).removeClass( "hidden" );
                    }
                    ...
                    $('.accountWith90Days_show input').removeAttr('data-validate');
                    $('.accountWithOut90Days_show input').removeAttr('data-validate');
                    $('.accountWithUsrPwd_show input').each(function() {
                        $(this).attr('data-validate', $(this).attr('data-validate-hidden'));
                    });
                }
            });
